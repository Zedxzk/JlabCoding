...
class JEventProcessor_pluginOfLMS:public jana::JEventProcessor{
	public:
		JEventProcessor_pluginOfLMS();
		~JEventProcessor_pluginOfLMS();
		const char* className(void){return "JEventProcessor_pluginOfLMS";}
		TTree* ecalHitsTree;
...
#endif // _JEventProcessor_pluginOfLMS_
